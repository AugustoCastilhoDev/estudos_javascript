...
if (formaPagamento === 1) {
    console.log('O valor pago foi de:', aplicarDesconto (precoProduto, 10));
} else if (formaPagamento === 2) {
    console.log('O valor pago foi de:', aplicarDesconto (precoProduto, 15));
} else if (formaPagamento === 3) {
    console.log('O valor pago foi de:', precoProduto);
} else {
    console.log('O valor pago foi de:', aplicarJuros (precoProduto, 10));
}
